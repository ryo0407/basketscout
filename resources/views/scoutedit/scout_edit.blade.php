...
<form method="post" action="{{ route('edit.scout', $editscout['id']) }}" class="container w-50 p-3 mx-auto mb-5">
@csrf

  <div class="mb-5">
    <label for="exampleInputEmail1" class="form-label">チーム名</label>
    <input type="text" name="team_name" class="form-control" value="{{ $editscout['team_name'] }}">
  </div>

  <div class="mb-5">
    <label for="exampleInputEmail1" class="form-label">活動場所</label>
    <input type="text" name="active_place" class="form-control" value="{{ $editscout['active_place'] }}">
  </div>

  <div class="mb-5">
    <label for="exampleInputEmail1" class="form-label">チームアドレス</label>
    <input type="text" name="team_address" class="form-control" value="{{ $editscout['team_address'] }}">
  </div>
