...
<div class="d-grid gap-2 col-4 mx-auto my-5">
    <a href="/top_player" button class="btn btn-primary col my-5" type="button">この内容で編集する</a>
    <a href="/top_player" button class="btn btn-secondary col my-3" type="button">戻る</a>
</div>
